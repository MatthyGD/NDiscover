...
help_menu() {
  ...
  echo -e "\n${YELLOW} Se recomienda seguir el flujo sugerido por la herramienta (Descubrimiento de Hosts, Escaneo con Nmap y creación de directorios y servidor en Python) para una experiencia óptima.${RESET}"
  echo -e "\n${YELLOW} Es importante destacar que, gracias a los múltiples protocolos utilizados durante los descubrimientos, se puede obtener información precisa tanto de la red local como de los puertos disponibles.${RESET}"
